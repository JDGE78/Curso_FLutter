...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String _ctextoAlCambiar = "No hay texto intrioducido";
  String _ctextoEnviado = "No hay texto enviado";
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(padding: EdgeInsets.all(10)),
                          Text(
                            '2. Texto que se esta intriduciendo en CUPERTINO',
                            style: style2,
                          ),
                          Text(
                            '$_ctextoAlCambiar',
